...
func TestCreateDemoPDF(t *testing.T) {
	...
	core.CreateTestPageContent(p)
	xRefTable, err := core.CreateDemoXRef()
	if err != nil {
		t.Fatalf("%s: %v\n", msg, err)
	}
	...
	if err = core.AddPageTreeWithSamplePage(xRefTable, rootDict, p); err != nil {
		t.Fatalf("%s: %v\n", msg, err)
	}
...
func TestResourceDictInheritanceDemoPDF(t *testing.T) {
	...
	xRefTable, err := core.CreateResourceDictInheritanceDemoXRef()
	if err != nil {
		t.Fatalf("%s: %v\n", msg, err)
	}
...
func TestAnnotationDemoPDF(t *testing.T) {
	...
	xRefTable, err := core.CreateAnnotationDemoXRef()
	if err != nil {
		t.Fatalf("%s: %v\n", msg, err)
	}
