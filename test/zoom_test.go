...
func TestZoomInByFactor(t *testing.T) {
	...
	zoom, err := core.ParseZoomConfig("factor:2", types.POINTS)
	if err != nil {
	...
	zoom, err = core.ParseZoomConfig("factor:4", types.POINTS)
	if err != nil {
		t.Fatalf("%s invalid zoom configuration: %v\n", msg, err)
	}
...
func TestZoomOutByFactor(t *testing.T) {
	...
	zoom, err := core.ParseZoomConfig("factor:.5", types.POINTS)
	if err != nil {
		t.Fatalf("%s invalid zoom configuration: %v\n", msg, err)
	}
	...
	zoom, err = core.ParseZoomConfig("factor:.25, border:true", types.POINTS)
	if err != nil {
		t.Fatalf("%s invalid zoom configuration: %v\n", msg, err)
	}
...
func TestZoomOutByHorizontalMargin(t *testing.T) {
	...
	zoom, err := core.ParseZoomConfig("hmargin:149", types.POINTS)
	if err != nil {
		t.Fatalf("%s invalid zoom configuration: %v\n", msg, err)
	}
	...
	zoom, err = core.ParseZoomConfig("hmargin:1, border:true, bgcol:lightgray", types.CENTIMETRES)
	if err != nil {
		t.Fatalf("%s invalid zoom configuration: %v\n", msg, err)
	}
...
func TestZoomOutByVerticalMargin(t *testing.T) {
	...
	zoom, err := core.ParseZoomConfig("vmargin:1", types.INCHES)
	if err != nil {
		t.Fatalf("%s invalid zoom configuration: %v\n", msg, err)
	}
	...
	zoom, err = core.ParseZoomConfig("vmargin:30, border:false, bgcol:lightgray", types.MILLIMETRES)
	if err != nil {
		t.Fatalf("%s invalid zoom configuration: %v\n", msg, err)
	}
