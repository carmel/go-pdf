...
func TestResizeByScaleFactor(t *testing.T) {
	...
	res, err := core.ParseResizeConfig("sc:2", types.POINTS)
	if err != nil {
	...
	// Shrink by 50%.
	res, err = core.ParseResizeConfig("sc:.5", types.POINTS)
	if err != nil {
		t.Fatalf("%s invalid resize configuration: %v\n", msg, err)
	}
...
func TestResizeByWidthOrHeight(t *testing.T) {
	...
	res, err := core.ParseResizeConfig("dim:200 0", types.POINTS)
	if err != nil {
		t.Fatalf("%s invalid resize configuration: %v\n", msg, err)
	}
	...
	res, err = core.ParseResizeConfig("dim:0 200", types.MILLIMETRES)
	if err != nil {
		t.Fatalf("%s invalid resize configuration: %v\n", msg, err)
	}
...
func TestResizeToFormSize(t *testing.T) {
	...
	res, err := core.ParseResizeConfig("form:A3", types.POINTS)
	if err != nil {
		t.Fatalf("%s invalid resize configuration: %v\n", msg, err)
	}
	...
	res, err = core.ParseResizeConfig("form:A4L", types.POINTS)
	if err != nil {
		t.Fatalf("%s invalid resize configuration: %v\n", msg, err)
	}
...
func TestResizeToDimensions(t *testing.T) {
	...
	res, err := core.ParseResizeConfig("dim:400 200, bgcol:#E9967A", types.POINTS)
	if err != nil {
		t.Fatalf("%s invalid resize configuration: %v\n", msg, err)
	}
	...
	res, err = core.ParseResizeConfig("dim:400 200, enforce:true, border:on", types.POINTS)
	if err != nil {
		t.Fatalf("%s invalid resize configuration: %v\n", msg, err)
	}
